...
public class CustomerLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(360, 250, 180, 50);
        ...
        jLabel4.setBounds(400, 370, 130, 40);
        ...
        jButton2.setBounds(600, 500, 150, 50);
        ...
        jLabel2.setBounds(0, 90, 1260, 730);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        new CustomerCreateAccount().show();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            {
                JOptionPane.showMessageDialog(null," Provide Customer ID / Password","Error",JOptionPane.ERROR_MESSAGE);
            }
            else
            {
              String userid= Customerdao.isValidLogin(c);
              if(userid.equals(c.getUserId()))
               {
                 JOptionPane.showMessageDialog(null,"Customer Login Succesfully","Log in",JOptionPane.INFORMATION_MESSAGE);
               }
               else
               {
                 JOptionPane.showMessageDialog(null,"Customer ID / Password is Incorrect","Error",JOptionPane.ERROR_MESSAGE);
               }      
            }
        }
        catch(Exception e)
        {
        JOptionPane.showMessageDialog(null,"User ID/Pssword is Inccorect","Exception",JOptionPane.ERROR_MESSAGE);
        }
