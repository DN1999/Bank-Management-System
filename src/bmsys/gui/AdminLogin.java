...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1255, 758));
        setResizable(false);
        ...
        jLabel3.setBounds(360, 250, 170, 50);
        ...
        jButton3.setBounds(1140, 100, 100, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            {
                JOptionPane.showMessageDialog(null," Provide Admin User ID / Password","Error",JOptionPane.ERROR_MESSAGE);
            }
            else
            {
              String userid= Admindao.isValidLogin(c);
              if(userid.equals(c.getUserId()))
               {
                 JOptionPane.showMessageDialog(null,"Admin Login Succesfully","Log in",JOptionPane.INFORMATION_MESSAGE);
                 new EmployeeOption().show();
                 dispose();
               }
               else
               {
                 JOptionPane.showMessageDialog(null,"Admin User ID / Password is Incorrect","Error",JOptionPane.ERROR_MESSAGE);
               }      
            }
        }
        catch(Exception e)
        {
        JOptionPane.showMessageDialog(null,"Admin User ID/Pssword is Inccorect","Exception",JOptionPane.ERROR_MESSAGE);
        }
